...
import com.barber.shop.queue.system.LoginRegister.view.LoginRegisterHost;
import com.barber.shop.queue.system.LoginRegister.view.UserLoggedIn;
...
public class BarberQueueApplication extends Application {
    ...
    private static final String TAG = BarberQueueApplication.class.getSimpleName();
    ...
    public void checkUserLogin(final Context context) {
        if (firebaseAuth.getCurrentUser() != null) {
            Intent profileIntent = new Intent(context, UserLoggedIn.class);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (null != user) {
                    ...
                    Intent loginIntent = new Intent(context, LoginRegisterHost.class);
